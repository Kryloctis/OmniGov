...
namespace Accounting.Data.Repositories
{
    public class JEVRepository : IJEVRepository
    {
        ...
        public int GetLastInsertedID()
        {
            ...
            return int.Parse(genericCommands.ExecuteScalar(query));
        }
        ...
        public int JevCounterByJournal(string fundName, int year, string journalName)
        {
            ...
            bool isResultValid = int.TryParse(genericCommands.ExecuteScalar(query, parameters), out int result);
        ...
        public string GetLastJevNoSeries(int fundId)
        {
            ...
            return genericCommands.ExecuteScalar(query, parameters);
        }
        ...
        public bool TrnsctnNoExist(string trnsctnNo)
        {
            ...
            return !string.IsNullOrWhiteSpace(genericCommands.ExecuteScalar(query, parameters));
        }
