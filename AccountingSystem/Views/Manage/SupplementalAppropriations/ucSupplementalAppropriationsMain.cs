    ...
    public partial class ucSupplementalAppropriationsMain : UserControl
    {
        ...
        internal string GetFormErrors()
        {
            var errorArray = new string[]
            {
                ...
                dgSupplementalAppropriations.Tag.ToString()
            };
        ...
        {
            Helper.EnableDisableButtons(dgSupplementalAppropriations, btnEdit, btnDelete);
        }
        ...
        private void ucSupplementalAppropriationsMain_Load(object sender, EventArgs e)
        {
            if (!DesignMode)
            {
                Helper.EnableDisableButtons(dgSupplementalAppropriations, btnEdit, btnDelete);
        ...
        private void dgSupplementalAppropriations_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if (dgSupplementalAppropriations.RowCount < 1)
            {
                dgSupplementalAppropriations.Tag = Helper.ErrorMessage("Supplemental Appropriation");
                e.Cancel = true;
                return;
            }
            e.Cancel = false;
        ...
        private void dgSupplementalAppropriations_Validated(object sender, EventArgs e)
        {
            dgSupplementalAppropriations.Tag = string.Empty;
        }
