...
{
    public partial class frmRptTaxPayment : Form
    {
        private readonly frmPaymentPosting _frmPaymentPosting;
        public frmRptTaxPayment(frmPaymentPosting frmPaymentPosting)
        {
            InitializeComponent();
        ...
        private void frmRptTaxPayment_Load(object sender, EventArgs e)
        {
