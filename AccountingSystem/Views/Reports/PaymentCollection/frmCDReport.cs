...
namespace AccountingSystem.Views.Reports.PaymentCollection
{
    public partial class frmCDReport : Form
    {
        ...
        private DataTable DataTableData(string rcdId)
        {
            ...
            var dt = Factory.GeneralCollectionsRepository().GetRecordByData("31");
            if (dt.Rows.Count > 0)
            {
        ...
        private DataTable DataTableForms(int id)
        {
            ...
            var dt = Factory.GeneralCollectionsRepository().GetRecordByForms(31);
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow item in dt.Rows)
                {
        ...
        private DataTable DataTableCollections(int rcdNo)
        {
            ...
            var dt = Factory.GeneralCollectionsPaymentsRepository().GetCollectionPaymentByRCDNo("RCD-100-718");
