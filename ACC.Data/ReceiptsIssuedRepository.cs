...
namespace ACC.Data
{
    public class ReceiptsIssuedRepository : IReceiptsIssuedRepository
    {
        ...
        public ReceiptsIssuedRepository(AccGenericCommands mySqlGenericCommandsLFS)
        {
        ...
        public bool ReceiptAvailabilityByQuantity(int receiptId, int receiptQuantity)
        {
            ...
            int queryResult = int.Parse(mySqlGenericCommandsLFS.ExecuteScalar(query, parameters));
