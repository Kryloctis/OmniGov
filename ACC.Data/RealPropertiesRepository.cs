    ...
    public class RealPropertiesRepository : IRealPropertiesRepository
    {
        ...
        public bool Insert(RealPropertiesModel entity)
        {
            var parameters = new object[][]
            {
                ...
                new object[] { "@effectivity_quarter", DbType.String, entity.EffectivityQuarter},
                new object[] { "@effectivity_year", DbType.String, entity.EffectivityYear},
                new object[] { "@other_improvements", DbType.String, entity.OtherImprovements},
                new object[] { "@assessed_value", DbType.String, entity.AssessedValue},
                new object[] { "@area", DbType.String, entity.Area},
                ...
                new object[] { "@is_taxable", DbType.String, entity.IsTaxable},
                new object[] { "@is_cancelled", DbType.String, entity.IsCancelled}
            };
