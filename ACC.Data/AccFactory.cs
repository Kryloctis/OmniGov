...
namespace AccountingSystem
{
    public static class AccFactory
    {
        ...
        public static IActualUseCodes ActualUseCodes() => new ActualUseCodesRepository(mySqlGenericCommandsLFS);
        public static IClassificationCodes ClassificationCodes() => new ClassificationCodesRepository(mySqlGenericCommandsLFS);
    }
}