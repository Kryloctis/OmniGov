...
{
    public partial class ucCheckDisbursementsJrnlReport : UserControl
    {
        public ucCheckDisbursementsJrnlReport()
        {
            InitializeComponent();
        ...
        private void LoadReport(ReportViewer reportViewer)
        {
            ...
            string journalName = "Check Disbursements Journal";
            int journalId = 5;
            ...
            var dtCheckDisbursementFromDB = AccountingFactory.JEVAccountsRepository().GetViewRecordsByFundJournalDate(dictFund["fund_name"], journalName, date);

            int jevId;
            string jevNo;
            string particulars;

            var checkDisbursementsRepository = AccountingFactory.CheckDisbursementsJournalRepository();
            ...
            var dictSignatory = Helper.GetSigtryByRefDoc("Certified Correct", "Check Disbursements Journal");
            ...
            localReport.ReportPath = $"{Application.StartupPath}\\Reports\\check-disbursements-journal.rdlc";
            localReport.DataSources.Clear();

            localReport.DataSources.Add(new ReportDataSource("CheckDisbursementsJournal", dtCheckDisbursementsJournal.Clone()));
