...
namespace OmniGov.App.Accounting.Views.Reports.Journals
{
    public partial class ucCashDisbursementJrnlReport : UserControl
    {
        ...
        private void LoadReport(ReportViewer reportViewer)
        {
            ...
            var dtCashDisbursementFromDB = AccountingFactory.JEVAccountsRepository().GetViewRecordsByFundJournalDate(dictFund["fund_name"], journalName, date);
            ...
            var dictSignatory = Helper.GetSigtryByRefDoc("Certified Correct", "Cash Disbursements Journal");
